 ...
 * > and the namespace aliases that apply to this DocBlock. These are used by the NodeFactoryProducer to resolve and expand partial
 ...
 *     );
 *
 * It is generally recommended to use the NodeFactoryProducer as that will also apply escaping rules, while the Description object
